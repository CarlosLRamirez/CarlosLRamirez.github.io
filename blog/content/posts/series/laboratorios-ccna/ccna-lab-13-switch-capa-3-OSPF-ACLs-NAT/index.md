...
- [Objetivo](#1-objetivo)
- [Descripción del Escenario](#2-descripción-del-escenario)
- [Diagrama de Red](#3-diagrama-de-red)
- [Archivo Inicial de Packet Tracer](#4-archivo-inicial-de-packet-tracer)
- [Detalle de Direccionamiento IP y Asignación de VLANs](#5-detalle-de-direccionamiento-ip-y-asignación-de-vlans)
- [Instrucciones](#6-instrucciones)
- [Resolución Paso a Paso](#7-resolución-paso-a-paso)
  - [Parámetros Iniciales](#71-parámetros-iniciales)
  - [Acceso por SSH](#72-acceso-por-ssh)
  - [Configuración de Enlaces WAN](#73-configuración-de-enlaces-wan)
  - [Configuración de VLANs y Puertos de Switch](#74-configuración-de-vlans-y-puertos-de-switch)
  - [Enrutamiento Inter-VLAN por medio de SVIs](#75-enrutamiento-inter-vlan-por-medio-de-svis)
  - [Direcciones de los Hosts](#76-direcciones-de-los-hosts)
  - [Configuración de OSPF](#77-configuración-de-ospf)
  - [Configuración de Salida a Internet](#78-configuración-de-salida-a-internet)
  - [Políticas de Seguridad mediante ACLs](#79-políticas-de-seguridad-mediante-acls)
  - [Configuración de NAT](#710-configuración-de-nat-en-l3-cr)
...
![LAB10-DIAGRAMA](ccna-lab-13-topologia.png)  

## 4. Archivo inicial de Packet Tracer

Este es el archivo del laboratorio con la [configuración inicial](ccna-lab-13-SVI-OSFP-AC-NAT-init.pkt).
...
![picture 1](ccna-lab-13-config-hn1.png)  
...
**Comparado con el [Lab 11 (Router-on-Stick)](../ccna-lab-11-router-on-stick-ospf-acls/index.md), has aprendido:**
...
[Archivo con Laboratorio resuelto](ccna-lab-13-SVI-OSFP-AC-NAT-final.pkt)
