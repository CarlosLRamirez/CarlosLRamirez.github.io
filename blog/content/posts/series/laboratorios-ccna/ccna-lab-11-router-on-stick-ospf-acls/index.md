...
![Lab09-Diagrama](ccna-lab-11-topologia.png)  

## 4. Archivo inicial de Packet Tracer

Este es el archivo del laboratorio con la [configuración inicial](ccna-lab-11-source-init.pkt)
...
- Configure las interfaces de los enlaces WAN en los routers de GT, HN y CR de acuerdo a la [Tabla de Asignación de IPs](#5.2.%20Tabla%20de%20Asignación%20de%20IPs)
- Agregue una descripción en las interfaces.

### 6.4. Sección 4: VLANs y Puertos de Switch
- Configure las VLANs en S-HN, S-GT y S-CR de acuerdo a la información proporcionada en la [Tabla de VLANs y Subredes Asignadas](#5.1.%20Tabla%20de%20VLANs%20y%20Subredes%20Asignadas).
- Configure los puertos de acceso en S-HN y S-GT según la información proporcionada en la [Tabla de VLANs y Subredes Asignadas](#5.1.%20Tabla%20de%20VLANs%20y%20Subredes%20Asignadas).
- Configure los enlaces troncales en S-HN, S-GT y S-CR de forma estática, de acuerdo con la [Tabla de VLANs y Subredes Asignadas](#5.1.%20Tabla%20de%20VLANs%20y%20Subredes%20Asignadas). ***Únicamente debe permitir el tráfico de las VLANs utilizadas en el ejercicio y rechazar cualquier tráfico que pertenezca a otra VLAN.***
- Habilite las interfaces de administración en S-HN, S-GT y S-CR y asigne las direcciones IP, de acuerdo con la información proporcionada en la [Tabla de Asignación de IPs](#5.2.%20Tabla%20de%20Asignación%20de%20IPs).
- Configure lo necesario para que el switch pueda ser alcanzado desde redes externas.

### 6.5. Sección 5: Enrutamiento Inter-VLAN
- Habilite el enrutamiento inter-VLAN en los routers R-HN, R-GT y R-CR mediante la configuración de las subinterfaces correspondientes, según lo indicado en la [Tabla de Asignación de IPs](#5.2.%20Tabla%20de%20Asignación%20de%20IPs). No olvide habilitar el enrutamiento IPv4 en los routers.

### 6.6. Sección 6: Direcciones de los Hosts
- Asigne las direcciones IP a las PCs de acuerdo a la información proporcionada en la [Tabla de Asignación de IPs](#5.2.%20Tabla%20de%20Asignación%20de%20IPs).
...
![picture 1](ccna-lab-11-configuracion-PC-HN1.png)  
...
¡Felicidades! Has completado exitosamente este laboratorio de integración avanzada. Este ejercicio te ha preparado para enfrentar escenarios reales de redes empresariales donde necesitas:

- Conectar múltiples sedes geográficas
- Segmentar usuarios según roles y permisos
- Implementar enrutamiento dinámico escalable
- Aplicar políticas de seguridad granulares
- Gestionar acceso a recursos compartidos

La combinación de Router-on-Stick, OSPF y ACLs que has dominado aquí es fundamental en el mundo profesional. Estas habilidades te permitirán diseñar, implementar y administrar redes empresariales seguras y eficientes.

Espero que este laboratorio haya sido valioso en tu camino de aprendizaje por el fascinante mundo de las redes. Si tienes alguna observación, sugerencia de mejora, o pregunta sobre la configuración, ¡déjala en los comentarios! Tu retroalimentación ayuda a mejorar continuamente estos recursos educativos.

**Sigue practicando, sigue aprendiendo, y ©xito en tu certificación CCNA!**

---

[Archivo con Laboratorio resuelto](ccna-lab-11-source-final.pkt)
